...
func (in *HeadGroupSpec) DeepCopyInto(out *HeadGroupSpec) {
	*out = *in
	...
	if in.ServiceReconciliationConfig != nil {
		in, out := &in.ServiceReconciliationConfig, &out.ServiceReconciliationConfig
...
func (in *ReconciliationConfig) DeepCopyInto(out *ReconciliationConfig) {
	*out = *in
	if in.EnableReconciliation != nil {
		in, out := &in.EnableReconciliation, &out.EnableReconciliation
		*out = new(bool)
		**out = **in
	}
	if in.ReconciliationThresholdInSeconds != nil {
		in, out := &in.ReconciliationThresholdInSeconds, &out.ReconciliationThresholdInSeconds
		*out = new(float64)
		**out = **in
	}
}
